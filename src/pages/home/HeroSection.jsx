...
const HeroSection = ({toggleModal}) => {
  return (
    ...
    <div className=" w-full sm:w-[600px] h-fit mt-[60px] xs:mt-[40px]  text-white  text-center flex flex-col items-center justify-center ">
      ...
      <span className=" relative z-10 text-[11px] xs:text-[13px] sm:text-[15px] mt-5 font-bold text-ginger-red tracking-wider uppercase  ">
      DISCOVER. STOCK UP. REPEAT
      </span>

      <h1 className=" relative z-10 text-[40px] xs:text-[50px] sm:text-[59px] mt-3  px-2 xs:px-3  font-merchant leading-[1.2] ">
      Africa's one-stop beauty sourcing platform.
      </h1>

      <p className=" relative z-10 w-[300px] xs:w-[370px] text-[12.5px] xs:text-[16px]  mt-4 mb-8 leading-[1.4] ">
     ...
     <span className='relative z-10'> <PillButton toggleModal={toggleModal} text='Join Waitlist' px='px-8'/></span>
    </div>
  </div>
  )
}
