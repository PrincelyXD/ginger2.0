  ...
  return (
      ...
      <div className=" w-full h-fit py-[50px] pb-[80px]  bg-[#FFF2EF] flex flex-col items-center">
       ...
       transition={{ duration: 0.4, delay: 0.1 }}
          className=" xs:w-[420px] h-[200px] sm:h-[300px] px-2 text-center flex flex-col justify-center"
        >
          ...
          <p className=" text-[16px] text-[#262626] mt-2 px-6 leading-[1.5]">
            We do the hard work of finding and vetting manufacturers so you
            don’t have to.
          </p>
        </motion.div>

        <section className="  w-[100%] md:w-[90%] max-w-[1050px] px-5 md:px-0  h-fit md:h-[550px] mx-[5px] mt-[40px]  sm:mt-0 flex flex-col md:flex-row rounded-[30px] justify-center items-center   ">
          <motion.section
           initial={{ opacity: 0, transform: "translateY(20px)" }}
           whileInView={{ opacity: 1, transform: "translateY(0px)" }}
           viewport={{ once: true }}
           transition={{ duration: 0.4, delay: 0.2 }}
            className={` sm:w-[500px] ${
              isDesktop &&
              (isExpanded === "first" ? "md:w-[75%]" : "md:w-[25%]")
              ...
              isExpanded === "first" && (
                <div className=" desc md:w-[65%]  lg:w-[52%] h-[50%] md:h-full  px-8   pt-5 pb-5 md:pb-8 md:pt-[100px] relative overflow-hidden">
                  <h1 className=" text-[25px] md:text-[35px] font-merchant leading-[1.2] relative z-10">
                    Your gateway to sourcing quality wholesale beauty and
                    fashion products
                  </h1>
          ...
          <motion.section
           ...
           transition={{ duration: 0.4, delay: 0.2 }}
            ...
            className={`w-full sm:w-[500px]  ${
              isDesktop &&
              (isExpanded === "second" ? "md:w-[75%]" : "md:w-[25%]")
          ...
          >
            ...
            {isDesktop ? (
              ...
              >
                ...
                >
                  Reach millions of business customers across Africa and grow
                  your brand
                </h1>
